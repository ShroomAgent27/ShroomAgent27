...
# $LOCAL is this server
echo 1 > /proc/sys/net/ipv4/ip_forward

# ovh
iptunnel add gre1 mode gre local $LOCAL remote 142.4.202.40 ttl 255
...
iptunnel add gre2 mode gre local $LOCAL remote 64.32.6.180 ttl 255
...
#iptunnel add gre2 mode gre local $LOCAL remote 198.251.81.234 ttl 255
